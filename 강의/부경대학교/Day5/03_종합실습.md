...
1. **입력 데이터 읽기**
   - HDFS 경로: `hdfs://namenode:8020/user/user/data/raw/ecommerce/2026/02/14/ecommerce_logs.csv`
...
3. **분석 결과를 HDFS에 저장**
   ...
   - 저장 경로: `hdfs://namenode:8020/user/user/data/processed/ecommerce/2026/02/14/`
